...
const StreamMobile = (props) => {
    ...
    const streamedSentences = (sentences) => {
        ...
        // }, 1000)
        // setTimeout(function(){
        //     props.sentences.push({id: "1", contradiction: true, sentence: "this is an update2", speaker: 'trump', timestamp: 1233});
        //     props.loadSentences(props.sentences)
        //     console.log(props.sentences[props.sentences.length - 1])
...
export default withStyles(styles)(StreamMobile)
